...
def init_test_data():
    user = User("gavrilo")
    user.key_manager.generate_key_pair(algorithm=Algorithm.RSA, key_size=1024, password="1234",
    ...
    user2 = User("stanoje")
    user2.key_manager.generate_key_pair(algorithm=Algorithm.RSA, key_size=1024, password="1234",
