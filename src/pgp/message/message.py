...
class PGPMessage:
    def __init__(self,
                 message_and_optional_signature_compressed_bytes: bytes,
                 is_encrypted: bool,
        ...
        self.message_and_optional_signature_compressed_bytes = message_and_optional_signature_compressed_bytes
    ...
    def to_bytes(self):
        ...
        byte_array += write_chunk(self.message_and_optional_signature_compressed_bytes)
    ...
    def from_bytes(cls, data: bytes):
        ...
        message_and_optional_signature_compressed_bytes, offset = read_chunk(data, offset)
        ...
        return cls(
            message_and_optional_signature_compressed_bytes=message_and_optional_signature_compressed_bytes,
    ...
    def __str__(self):
        return f'PGPMessage(message_and_optional_signature_compressed_bytes={self.message_and_optional_signature_compressed_bytes},' \
...
def test_pgp_message_serialization():
    pgp_message = PGPMessage(
        message_and_optional_signature_compressed_bytes=b'1234567890',
        is_encrypted=True,
    ...
    assert pgp_message.message_and_optional_signature_compressed_bytes == pgp_message_deserialized.message_and_optional_signature_compressed_bytes
